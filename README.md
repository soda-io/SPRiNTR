...
- По внешнему виду я хочу сделать этот принтер в виде куба. Двигаться он будет с помощью колес и подниматься по оси **Z** с помощью спец. механизмов, которые будут поднимать колеса => по оси **Z**. Экструдер будет находиться на вержней крышке конструкции. Чтобы избежать зацепления моделей, две противоположныестенки будут отклоняться на 90'
