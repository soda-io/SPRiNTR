...
## == РИСКИ ==
Я не знаю как себя покажет новый принтер, но нужно пробывать все варианты. Возможно качество моделей будет хуже, а возможно и лучше. Я буду стараться делать все возможное, чтобы принтер соответствовал своим конкурентам и в чем-то опережал их.

## == КОНКУРЕНТЫ ==
На сегодняшний день конкурентов очень много из которых:
